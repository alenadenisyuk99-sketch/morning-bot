...
horoscope_text = claude(f"""Ти веселий астролог для команди маркетологів. Сьогодні {today.strftime("%d.%m.%Y")}.

Напиши гороскоп для всіх 12 знаків. Правила:
- Рівно 2 речення на знак
- Конкретно і практично: брифи, дедлайни, клієнти, ідеї, кампанії, контент
- Тон: жартівливий, трохи зухвалий
- Мова: українська
...
Напиши 3 речення українською для команди маркетологів.
Що ця карта означає для творчої роботи сьогодні? Дотепно і конкретно. Темні карти — як творчий виклик.
