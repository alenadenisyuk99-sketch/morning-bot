...
horoscope_text = claude(f"""Ти веселий астролог. Сьогодні {today.strftime("%d.%m.%Y")}.

Напиши щоденний гороскоп для команди — живих людей, які вранці читають чат. Не інструкція по роботі, а справжній гороскоп: про настрій дня, енергію, стосунки з колегами, на що звернути увагу в собі, які сюрпризи може принести день.

Правила:
- Рівно 2 речення на знак
- Людяно і тепло, з гумором — як пише класний астролог в Instagram
- Можна згадати: настрій, інтуїцію, спілкування, рішення, натхнення, відпочинок, несподіванки
- НЕ пиши про конкретні робочі задачі, рубрики, контент-план
- Мова: українська
...
Напиши 3 речення українською — тепло, з гумором, як для живих людей які починають свій день.
